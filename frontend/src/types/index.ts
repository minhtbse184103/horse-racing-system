// ADDED FROM ZIP FRONTEND MERGE:
// Shared frontend types copied into the current frontend project without
// changing backend code or replacing existing frontend files.

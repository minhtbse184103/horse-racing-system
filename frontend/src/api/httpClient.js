...
const MESSAGE_TRANSLATIONS = {
  ...
  'Only a tournament open for registration can be closed.': 'Chỉ Tournament đang OPEN_FOR_REGISTRATION mới có thể đóng Registration.',
  ...
  'Only a race open for registration can be closed.': 'Chỉ Race đang OPEN_FOR_REGISTRATION mới có thể đóng Registration.',
  'A cancelled race cannot be completed.': 'Race đã CANCELLED không thể hoàn tất.',
  'Race is already completed.': 'Race đã COMPLETED.',
  'Race must be in progress before it can be completed.': 'Race phải ở trạng thái IN_PROGRESS trước khi hoàn tất.',
  ...
  'Only an in-progress launched race can be marked failed.': 'Chỉ Race đã khởi chạy và đang IN_PROGRESS mới có thể đánh dấu lỗi.',
  ...
  'Race must be in progress before results can be recorded.': 'Race phải IN_PROGRESS trước khi ghi nhận kết quả.',
  ...
  'Race must be pending result review before approval.': 'Race phải ở trạng thái PENDING_REVIEW trước khi duyệt kết quả.',

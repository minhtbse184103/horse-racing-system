const STYLES = {
  ...
  openforregistration: { label: "OpenForRegistration", cls: "bg-emerald-50 text-emerald-800 border-emerald-700/20" },
  closedregistration: { label: "ClosedRegistration", cls: "bg-cream-200 text-brown-900 border-brown-900/20" },
...
export default function StatusBadge({ status }) {
  ...
  const s = STYLES[key] ?? { label: status || "Draft", cls: STYLES.draft.cls };
  return (

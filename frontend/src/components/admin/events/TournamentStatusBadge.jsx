...
export default function TournamentStatusBadge({ status }) {
  ...
  return (
    <motion.span
      ...
      className={`inline-flex min-h-8 max-w-full items-center gap-2 whitespace-nowrap rounded-full border px-3 py-1.5 text-[0.7rem] font-black uppercase leading-none shadow-[0_4px_12px_rgba(43,23,16,0.07)] before:size-1.5 before:shrink-0 before:rounded-full before:shadow-[0_0_0_3px_rgba(255,255,255,0.7)] ${

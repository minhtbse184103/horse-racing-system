...
VALUES
  (1, 2,  'Alice Tran', DATE_SUB(@seed_today, INTERVAL 35 YEAR), 'FEMALE', 'Vietnamese', 'Bangkok Stable District', 'APPROVED', NULL, DATE_SUB(@seed_now, INTERVAL 120 DAY), DATE_SUB(@seed_now, INTERVAL 118 DAY), 1, DATE_SUB(@seed_now, INTERVAL 120 DAY), DATE_SUB(@seed_now, INTERVAL 118 DAY)),
  (2, 3,  'Bao Nguyen', DATE_SUB(@seed_today, INTERVAL 40 YEAR), 'MALE',   'Vietnamese', 'Chiang Mai Racing Road',  'APPROVED', NULL, DATE_SUB(@seed_now, INTERVAL 110 DAY), DATE_SUB(@seed_now, INTERVAL 108 DAY), 1, DATE_SUB(@seed_now, INTERVAL 110 DAY), DATE_SUB(@seed_now, INTERVAL 108 DAY)),
  (3, 4,  'Chloe Le',   DATE_SUB(@seed_today, INTERVAL 32 YEAR), 'FEMALE', 'Vietnamese', 'Phuket Equestrian Park',  'APPROVED', NULL, DATE_SUB(@seed_now, INTERVAL 100 DAY), DATE_SUB(@seed_now, INTERVAL 98 DAY),  1, DATE_SUB(@seed_now, INTERVAL 100 DAY), DATE_SUB(@seed_now, INTERVAL 98 DAY)),
  (4, 10, 'Pending Owner', DATE_SUB(@seed_today, INTERVAL 28 YEAR), 'OTHER', 'Vietnamese', 'Ho Chi Minh City', 'PENDING', NULL, DATE_SUB(@seed_now, INTERVAL 2 DAY), NULL, NULL, DATE_SUB(@seed_now, INTERVAL 2 DAY), DATE_SUB(@seed_now, INTERVAL 2 DAY)),
  (5, 11, 'Rejected Owner', DATE_SUB(@seed_today, INTERVAL 29 YEAR), 'MALE', 'Vietnamese', 'Da Nang City', 'REJECTED', 'Identity document is not readable.', DATE_SUB(@seed_now, INTERVAL 5 DAY), DATE_SUB(@seed_now, INTERVAL 3 DAY), 1, DATE_SUB(@seed_now, INTERVAL 5 DAY), DATE_SUB(@seed_now, INTERVAL 3 DAY));
...
INSERT INTO `Horse`
  (`horseID`, `ownerID`, `passportNumber`, `horseName`, `breed`, `gender`, `color`, `dayOfBirth`, `weight`, `healthCertExpiry`, `horsePassportUrl`, `healthCertificateUrl`, `horseImageUrl`, `status`, `rejectionReason`, `createdAt`, `updatedAt`)
VALUES
  (1, 2, 'PASS-DEMO-001', 'Demo Thunder', 'Thoroughbred', 'MALE',   'Bay',      DATE_SUB(@seed_today, INTERVAL 4 YEAR), 480.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/1/passport.pdf', 'https://example.com/horses/1/health.pdf', 'https://example.com/horses/1/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (2, 2, 'PASS-DEMO-002', 'Demo Comet',   'Thoroughbred', 'MALE',   'Chestnut', DATE_SUB(@seed_today, INTERVAL 5 YEAR), 495.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/2/passport.pdf', 'https://example.com/horses/2/health.pdf', 'https://example.com/horses/2/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (3, 3, 'PASS-DEMO-003', 'Demo Atlas',   'Thoroughbred', 'MALE',   'Black',    DATE_SUB(@seed_today, INTERVAL 6 YEAR), 510.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/3/passport.pdf', 'https://example.com/horses/3/health.pdf', 'https://example.com/horses/3/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (4, 3, 'PASS-DEMO-004', 'Demo Rocket',  'Thoroughbred', 'MALE',   'Grey',     DATE_SUB(@seed_today, INTERVAL 4 YEAR), 500.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/4/passport.pdf', 'https://example.com/horses/4/health.pdf', 'https://example.com/horses/4/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (5, 4, 'PASS-DEMO-005', 'Demo Blaze',   'Thoroughbred', 'MALE',   'Bay',      DATE_SUB(@seed_today, INTERVAL 7 YEAR), 520.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/5/passport.pdf', 'https://example.com/horses/5/health.pdf', 'https://example.com/horses/5/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (6, 4, 'PASS-DEMO-006', 'Demo Legacy',  'Thoroughbred', 'MALE',   'Brown',    DATE_SUB(@seed_today, INTERVAL 8 YEAR), 530.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/6/passport.pdf', 'https://example.com/horses/6/health.pdf', 'https://example.com/horses/6/image.jpg', 'ACTIVE', NULL, @seed_now, @seed_now),
  (7, 4, 'PASS-DEMO-007', 'Demo Aurora',  'Thoroughbred', 'FEMALE', 'Grey',     DATE_SUB(@seed_today, INTERVAL 5 YEAR), 475.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/7/passport.pdf', 'https://example.com/horses/7/health.pdf', 'https://example.com/horses/7/image.jpg', 'PENDING', NULL, @seed_now, @seed_now),
  (8, 3, 'PASS-DEMO-008', 'Demo Eclipse', 'Thoroughbred', 'FEMALE', 'Black',    DATE_SUB(@seed_today, INTERVAL 6 YEAR), 490.00, DATE_ADD(@seed_today, INTERVAL 1 YEAR), 'https://example.com/horses/8/passport.pdf', 'https://example.com/horses/8/health.pdf', 'https://example.com/horses/8/image.jpg', 'REJECTED', 'Health certificate image is unclear.', @seed_now, @seed_now);

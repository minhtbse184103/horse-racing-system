...
VALUES
  (1, 2,  'VERIFIED', 'Alice Tran',       DATE_SUB(@seed_today, INTERVAL 35 YEAR), 'FEMALE', 'Vietnamese', 'Bangkok Stable District', '001000000002', 'https://picsum.photos/seed/kyc-2-front/900/560',  'https://picsum.photos/seed/kyc-2-back/900/560',  'https://picsum.photos/seed/kyc-2-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 121 DAY), DATE_SUB(@seed_now, INTERVAL 118 DAY), 1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 121 DAY), DATE_SUB(@seed_now, INTERVAL 118 DAY)),
  (2, 3,  'VERIFIED', 'Bao Nguyen',       DATE_SUB(@seed_today, INTERVAL 40 YEAR), 'MALE', 'Vietnamese', 'Chiang Mai Racing Road', '001000000003', 'https://picsum.photos/seed/kyc-3-front/900/560',  'https://picsum.photos/seed/kyc-3-back/900/560',  'https://picsum.photos/seed/kyc-3-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 111 DAY), DATE_SUB(@seed_now, INTERVAL 108 DAY), 1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 111 DAY), DATE_SUB(@seed_now, INTERVAL 108 DAY)),
  (3, 4,  'VERIFIED', 'Chloe Le',         DATE_SUB(@seed_today, INTERVAL 32 YEAR), 'FEMALE', 'Vietnamese', 'Phuket Equestrian Park', '001000000004', 'https://picsum.photos/seed/kyc-4-front/900/560',  'https://picsum.photos/seed/kyc-4-back/900/560',  'https://picsum.photos/seed/kyc-4-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 101 DAY), DATE_SUB(@seed_now, INTERVAL 98 DAY),  1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 101 DAY), DATE_SUB(@seed_now, INTERVAL 98 DAY)),
  (4, 5,  'VERIFIED', 'Demo Jockey Five', DATE_SUB(@seed_today, INTERVAL 27 YEAR), 'MALE', 'Vietnamese', 'Bangkok Racing Academy', '001000000005', 'https://picsum.photos/seed/kyc-5-front/900/560',  'https://picsum.photos/seed/kyc-5-back/900/560',  'https://picsum.photos/seed/kyc-5-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 201 DAY), DATE_SUB(@seed_now, INTERVAL 198 DAY), 1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 201 DAY), DATE_SUB(@seed_now, INTERVAL 198 DAY)),
  (5, 6,  'VERIFIED', 'Demo Jockey Six',  DATE_SUB(@seed_today, INTERVAL 26 YEAR), 'FEMALE', 'Vietnamese', 'Chiang Mai Racing Academy', '001000000006', 'https://picsum.photos/seed/kyc-6-front/900/560',  'https://picsum.photos/seed/kyc-6-back/900/560',  'https://picsum.photos/seed/kyc-6-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 191 DAY), DATE_SUB(@seed_now, INTERVAL 188 DAY), 1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 191 DAY), DATE_SUB(@seed_now, INTERVAL 188 DAY)),
  (6, 7,  'VERIFIED', 'Demo Jockey Seven',DATE_SUB(@seed_today, INTERVAL 24 YEAR), 'MALE', 'Vietnamese', 'Phuket Riding School', '001000000007', 'https://picsum.photos/seed/kyc-7-front/900/560',  'https://picsum.photos/seed/kyc-7-back/900/560',  'https://picsum.photos/seed/kyc-7-selfie/700/700',  DATE_SUB(@seed_now, INTERVAL 31 DAY),  DATE_SUB(@seed_now, INTERVAL 28 DAY),  1, NULL, DATE_ADD(@seed_now, INTERVAL 5 YEAR), DATE_SUB(@seed_now, INTERVAL 31 DAY),  DATE_SUB(@seed_now, INTERVAL 28 DAY)),
